...
function initializeIDB() {
    ...
    return new Promise(function (resolve, reject) {
        ...
        request.onupgradeneeded = function () {
            ...
            subscriptions.createIndex('template', 'name')
            subscriptions.createIndex('officeTemplate', ['office', 'name'])
...
function updateSubscription(db, subscription) {
    ...
    templateIndex.get(subscription.name).onsuccess = function (templateEvent) {
...
const dummy = {
    ...
    "activities": [{
        ...
        },
        {
            ...
            "attachment": {},
            "activityId": "ZYIST188TIyZtNLNFAuU"
        },
        {
            "canEdit": true,
            "status": "PENDING",
            "schedule": [{
                    "endTime": "2018-07-28T18:30:00.000Z",
                    "startTime": "2018-06-29T16:03:20.203Z",
                    "name": "Trial Period"
                },
                {
                    "endTime": "2018-06-29T16:03:20.203Z",
                    "startTime": "2018-06-29T16:03:20.203Z",
            ...
            "timestamp": "2018-07-09T15:43:13.050Z",
            "template": "office",
            ...
            "assignees": [],
            "attachment": {},
            "activityId": "tVuDTKsqd2m0qMjGbLL5"
        },
        {
            "canEdit": true,
            "status": "PENDING",
            ...
            "timestamp": "2018-07-09T14:15:39.147Z",
            "template": "plan",
            "title": "Hello Activity 1",
            ...
            "attachment": {},
            "activityId": "kVuj087hYxeebAEYdBkY"
        },
        {
            "canEdit": true,
            "status": "PENDING",
            ...
            "timestamp": "2018-07-19T13:47:41.049Z",
            "template": "plan",
            ...
            "attachment": {},
            "activityId": "3s9jqgZAWFDf2HijlhNt"
        },
        {
            "canEdit": true,
            "status": "PENDING",
            ...
            "attachment": {},
            "activityId": "lfFdaMBWDjBHzN9eKdGe"
        },
        {
            "canEdit": true,
            "status": "PENDING",
            ...
            "template": "plan",
            "title": "A TEST ACTIVITY",
            "description": "hello world this is nice",
            "office": "personal",
            "assignees": [
                "+918080808090",
                "+918178135274"
            ...
            "attachment": {},
            "activityId": "xsPBdc8TQDJ0R37yvLXy"
        },
        {
            "canEdit": true,
            "status": "PENDING",
            "schedule": [{
                "endTime": "2018-07-19T14:24:33.465Z",
                "startTime": "2018-07-19T14:24:21.739Z",
                "name": "when"
            }],
            "venue": [{
                "address": "",
            ...
            "timestamp": "2018-07-19T14:24:21.739Z",
            "template": "plan",
            "title": "A TEST ACTIVITY",
            "description": "hello world this is nice",
            "office": "personal",
            ...
            "attachment": {},
            "activityId": "1EeJHvXkqe63EEzBTXZP"
        },
        {
            "canEdit": true,
            "status": "PENDING",
            ...
            "attachment": {},
            "activityId": "SiWk1IpVzmanNeHZ4sXK"
        },
        {
            "canEdit": true,
            "status": "PENDING",
            ...
            "attachment": {},
            "activityId": "Wxt1fzLFJfvCmvrWrlA7"
        },
        {
            "canEdit": true,
            "status": "PENDING",
            ...
            "timestamp": "2018-07-19T17:42:07.507Z",
            "template": "plan",
            "title": "Hello world..........................",
            "description": "",
            "office": "personal",
            ...
            "attachment": {},
            "activityId": "0B5F8e1QRCVWF1x9I8GU"
        },
        {
            "canEdit": true,
            "status": "PENDING",
            ...
            "attachment": {},
            "activityId": "TJ0IhaRZJfIx27yRqmom"
        },
        {
            "canEdit": false,
            "status": "PENDING",
            ...
            "timestamp": "2018-07-20T05:52:54.779Z",
            "template": "office",
            "title": "office",
            ...
            "assignees": [],
            "attachment": {},
            "activityId": "N0RzluzuFD4JWWmJDY4v"
        },
        {
            "canEdit": false,
            "status": "PENDING",
        ...
        },
        {
            ...
            "timestamp": "2018-07-21T18:31:36.773Z",
            "template": "plan",
            "title": "A Nice stuff",
            ...
            "attachment": {},
            "activityId": "J1Ms2MbS95Z0wiOaaymZ"
        },
        {
            "canEdit": true,
            "status": "PENDING",
            ...
            "timestamp": "2018-07-24T08:05:59.938Z",
            "template": "office",
            "title": "batch moved to different file...",
            "description": "yo........................",
            "office": "office",
            "assignees": [
                "+910101010123",
            ...
            "activityId": "J5mqE4Rpmzq6M2xd9HHy"
        }
    ],
    "templates": [{
        "name": "office",
        "office": "office",
        "defaultTitle": "an office",
