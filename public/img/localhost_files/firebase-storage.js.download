! function (t, e) {
    ...
    try {
        ...
        var r = "https://firebasestorage.googleapis.com",
            ...
            c = function () {
                function t(t, e) {
                    this.code_ = h(t), this.message_ = "Firebase Storage: " + e, this.serverResponse_ = null, this.name_ = "FirebaseError"
                }
        ...
        function p() {
            return new c(l.UNKNOWN, "An unknown error occurred, please check the error payload for server response.")
        }
        ...
        function d() {
            return new c(l.CANNOT_SLICE_BLOB, "Cannot slice blob for upload. Please retry the upload.")
        }

        function _(t, e, r) {
            return new c(l.INVALID_ARGUMENT, "Invalid argument in `" + e + "` at index " + t + ": " + r)
        }
        ...
        function m(t, e) {
            return new c(l.INVALID_FORMAT, "String does not match format '" + t + "': " + e)
        }
        ...
        function y(t) {
            switch (t) {
                ...
                case g.DATA_URL:
                    return;
                default:
                    throw "Expected one of the event types: [" + g.RAW + ", " + g.BASE64 + ", " + g.BASE64URL + ", " + g.DATA_URL + "]."
            }
        }
        var R = function () {
            return function (t, e) {
            ...
            switch (t) {
                ...
                case g.DATA_URL:
                    return new R(function (t) {
                        var e = new U(t);
                        return e.base64 ? T(g.BASE64, e.rest) : function (t) {
                            var e;
                            try {
        ...
        function w(t) {
            for (var e = [], r = 0; r < t.length; r++) {
                ...
                if (n <= 127) e.push(n);
                    ...
                    if (r < t.length - 1 && 56320 == (64512 & t.charCodeAt(r + 1))) n = 65536 | (1023 & n) << 10 | 1023 & t.charCodeAt(++r), e.push(240 | n >> 18, 128 | n >> 12 & 63, 128 | n >> 6 & 63, 128 | 63 & n);
                    else e.push(239, 191, 189);
                else 56320 == (64512 & n) ? e.push(239, 191, 189) : e.push(224 | n >> 12, 128 | n >> 6 & 63, 128 | 63 & n)
            }
        ...
        function T(t, e) {
            switch (t) {
                case g.BASE64:
                    var r = -1 !== e.indexOf("-"),
                        n = -1 !== e.indexOf("_");
                    if (r || n) throw m(t, "Invalid character '" + (r ? "-" : "_") + "' found: is it base64url encoded?");
                    break;
                case g.BASE64URL:
                    var o = -1 !== e.indexOf("+"),
                        i = -1 !== e.indexOf("/");
                    if (o || i) throw m(t, "Invalid character '" + (o ? "+" : "/") + "' found: is it base64 encoded?");
        ...
        var U = function () {
            return function (t) {
                ...
                var e = t.match(/^data:([^,]+)?,/);
                if (null === e) throw m(g.DATA_URL, "Must be formatted 'data:[<mediatype>][;base64],<data>");
                var r = e[1] || null;
                null != r && (this.base64 = (n = r, o = ";base64", n.length >= o.length && n.substring(n.length - o.length) === o), this.contentType = this.base64 ? r.substring(0, r.length - ";base64".length) : r), this.rest = t.substring(t.indexOf(",") + 1);
                var n, o
            }
        }();
        var A, N = {
        ...
        var H = function () {
                function t() {
                    var t = this;
                    this.sent_ = !1, this.xhr_ = new XMLHttpRequest, this.errorCode_ = A.NO_ERROR, this.sendPromise_ = x(function (e, r) {
                ...
                return t.prototype.send = function (t, e, r, n) {
                    ...
                    (this.sent_ = !0, this.xhr_.open(e, t, !0), D(n)) && I(n, function (t, e) {
                        o.xhr_.setRequestHeader(t, e.toString())
                    });
                    return D(r) ? this.xhr_.send(r) : this.xhr_.send(), this.sendPromise_
                    ...
                    if (!this.sent_) throw b("cannot .getResponseText() before sending");
                    ...
                    D(this.xhr_.upload) && this.xhr_.upload.addEventListener("progress", t)
                }, t.prototype.removeUploadProgressListener = function (t) {
                    D(this.xhr_.upload) && this.xhr_.upload.removeEventListener("progress", t)
                }, t
            }(),
            z = function () {
                function t() {}
        ...
        var V = function () {
            ...
            return Object.defineProperty(t.prototype, "path", {
                ...
                if ("" === r.path) return r;
                throw n = e, new c(l.INVALID_DEFAULT_BUCKET, "Invalid default bucket '" + n + "'.")
        ...
        var $ = function () {
                return function (t, e, r, n) {
                    this.server = t, this.local = e || t, this.writable = !!r, this.xform = n || Y
                }
            }(),
            tt = null;
        ...
        function et() {
            if (tt) return tt;
            var t = [];
            t.push(new $("bucket")), t.push(new $("generation")), t.push(new $("metageneration")), t.push(new $("name", "fullPath", !0));
            var e = new $("name");
            ...
            var r = new $("size");
            return r.xform = function (t, e) {
                return D(e) ? +e : e
            }, t.push(r), t.push(new $("timeCreated")), t.push(new $("updated")), t.push(new $("md5Hash", null, !0)), t.push(new $("cacheControl", null, !0)), t.push(new $("contentDisposition", null, !0)), t.push(new $("contentEncoding", null, !0)), t.push(new $("contentLanguage", null, !0)), t.push(new $("contentType", null, !0)), t.push(new $("metadata", "customMetadata", !0)), tt = t
        }
        ...
        function ot(t, e) {
            ...
            if (!j(r.downloadTokens)) return null;
        ...
        function st(t, e, r) {
            ...
            var a, s, u, h, p, f;
            if (!(n <= r.length && r.length <= o)) throw a = n, s = o, u = t, h = r.length, a === s ? (p = a, f = 1 === a ? "argument" : "arguments") : (p = "between " + a + " and " + s, f = "arguments"), new c(l.INVALID_ARGUMENT_COUNT, "Invalid argument count in `" + u + "`: Expected " + p + " " + f + ", received " + h + ".");
        ...
        function ht() {
            return new ut(function (t) {
                if (!(function (t) {
                    ...
                    }(t) && t >= 0)) throw "Expected a number 0 or greater."
            })
        }

        function pt(t, e) {
            return new ut(function (e) {
                if (!(null === e || D(e) && e instanceof Object)) throw "Expected an Object.";
                void 0 !== t && null !== t && t(e)
            }, e)
        }
        ...
        var _t = function () {
            function t(t, e) {
                var r = 0,
                    n = "";
                q(t) ? (this.data_ = t, r = t.size, n = t.type) : t instanceof ArrayBuffer ? (e ? this.data_ = new Uint8Array(t) : (this.data_ = new Uint8Array(t.byteLength), this.data_.set(new Uint8Array(t))), r = this.data_.length) : t instanceof Uint8Array && (e ? this.data_ = t : (this.data_ = new Uint8Array(t.length), this.data_.set(t)), r = t.length), this.size_ = r, this.type_ = n
            }
            return t.prototype.size = function () {
                ...
                if (q(this.data_)) {
                    var n = this.data_,
                        o = (a = e, s = r, (i = n).webkitSlice ? i.webkitSlice(a, s) : i.mozSlice ? i.mozSlice(a, s) : i.slice ? i.slice(a, s) : null);
        ...
        var mt = function () {
            return function (t, e, r, n) {
                this.url = t, this.method = e, this.handler = r, this.timeout = n, this.urlParams = {}, this.headers = {}, this.body = null, this.errorHandler = null, this.progressCallback = null, this.successCodes = [200], this.additionalRetryCodes = []
            }
        }();
        ...
        function yt(t) {
            return function (e, r) {
                var n, o, i;
                return 401 === e.getStatus() ? n = new c(l.UNAUTHENTICATED, "User is not authenticated, please authenticate using Firebase Authentication and try again.") : 402 === e.getStatus() ? (i = t.bucket, n = new c(l.QUOTA_EXCEEDED, "Quota for bucket '" + i + "' exceeded, please view quota on https://firebase.google.com/pricing/.")) : 403 === e.getStatus() ? (o = t.path, n = new c(l.UNAUTHORIZED, "User does not have permission to access '" + o + "'.")) : n = r, n.setServerResponseProp(r.serverResponseProp()), n
            }
        }
        ...
        function Rt(t) {
            ...
            return function (r, n) {
                var o, i = e(r, n);
                return 404 === r.getStatus() && (o = t.path, i = new c(l.OBJECT_NOT_FOUND, "Object '" + o + "' does not exist.")), i.setServerResponseProp(n.serverResponseProp()), i
            }
        }
        ...
        function Et(t, e, r) {
            var n = Z(e.fullServerUrl()),
                ...
                i = new mt(n, "GET", gt(t, r), o);
            return i.errorHandler = Rt(e), i
        }

        function wt(t, e, r) {
            var n = Z(e.fullServerUrl()),
                o = t.maxOperationRetryTime(),
                i = new mt(n, "GET", function (t, e) {
                    return function (r, n) {
                        var o = nt(t, n, e);
                        return bt(null !== o), ot(o, n)
                    }
                }(t, r), o);
            return i.errorHandler = Rt(e), i
        }
        ...
        function Tt(t, e, r) {
            var n = P(r);
            return n.fullPath = t.path, n.size = e.size(), n.contentType || (n.contentType = function (t, e) {
                return t && t.contentType || e && e.type() || "application/octet-stream"
            }(null, e)), n
        }
        var Ut = function () {
            return function (t, e, r, n) {
                this.current = t, this.total = e, this.finalized = !!r, this.metadata = n || null
            }
        }();
        ...
        function At(t, e) {
            ...
            return bt(vt(e || ["active"], r)), r
        }

        function Nt(t, e, r, n, o, i, a, s) {
            var u = new Ut(0, 0);
            if (a ? (u.current = a.current, u.total = a.total) : (u.current = 0, u.total = n.size()), n.size() !== u.total) throw new c(l.SERVER_FILE_WRONG_SIZE, "Server recorded incorrect upload file size, please retry the upload.");
            ...
            var f = u.current,
                ...
                m = n.slice(f, _);
            if (null === m) throw d();
            var b = e.maxUploadRetryTime(),
                g = new mt(r, "POST", function (t, r) {
                    var o, a = At(t, ["active", "final"]),
                        s = u.current + p,
                        c = n.size();
                    return o = "final" === a ? gt(e, i)(t, r) : null, new Ut(s, c, "final" === a, o)
                }, b);
            return g.headers = v, g.body = m.uploadData(), g.progressCallback = s || null, g.errorHandler = yt(t), g
        }
        var Ot = function () {
                return function (t, e, r) {
                    if (W(t) || D(e) || D(r)) this.next = t, this.error = e || null, this.complete = r || null;
                    else {
                        var n = t;
            ...
            Ct = function () {
                return function (t, e, r, n, o, i) {
                    this.bytesTransferred = t, this.totalBytes = e, this.state = r, this.metadata = n, this.task = o, this.ref = i
                }
            }();
        ...
        var kt = function () {
                function t(t, e, r, n, o, i) {
                    void 0 === i && (i = null);
                    var a = this;
                    this.transferred_ = 0, this.needToFetchStatus_ = !1, this.needToFetchMetadata_ = !1, this.observers_ = [], this.error_ = null, this.uploadUrl_ = null, this.request_ = null, this.chunkMultiplier_ = 1, this.resolve_ = null, this.reject_ = null, this.ref_ = t, this.authWrapper_ = e, this.location_ = r, this.blob_ = o, this.metadata_ = i, this.mappings_ = n, this.resumable_ = this.shouldDoResumable_(this.blob_), this.state_ = O.RUNNING, this.errorHandler_ = function (t) {
                        a.request_ = null, a.chunkMultiplier_ = 1, t.codeEquals(l.CANCELED) ? (a.needToFetchStatus_ = !0, a.completeTransitions_()) : (a.error_ = t, a.transition_(O.ERROR))
                    }, this.metadataErrorHandler_ = function (t) {
                        a.request_ = null, t.codeEquals(l.CANCELED) ? a.completeTransitions_() : (a.error_ = t, a.transition_(O.ERROR))
                    }, this.promise_ = x(function (t, e) {
                ...
                return t.prototype.makeProgressCallback_ = function () {
                    ...
                    this.state_ === O.RUNNING && null === this.request_ && (this.resumable_ ? null === this.uploadUrl_ ? this.createResumable_() : this.needToFetchStatus_ ? this.fetchStatus_() : this.needToFetchMetadata_ ? this.fetchMetadata_() : this.continueUpload_() : this.oneShotUpload_())
                    ...
                    this.resolveToken_(function (e) {
                        var r = function (t, e, r, n, o) {
                                ...
                                return p.urlParams = s, p.headers = c, p.body = l, p.errorHandler = yt(e), p
                            }(t.authWrapper_, t.location_, t.mappings_, t.blob_, t.metadata_),
                            n = t.authWrapper_.makeRequest(r, e);
                        t.request_ = n, n.getPromise().then(function (e) {
                    ...
                    this.resolveToken_(function (r) {
                        var n = function (t, e, r, n) {
                                var o = t.maxUploadRetryTime(),
                                    i = new mt(r, "POST", function (t, e) {
                                        var r, o = At(t, ["active", "final"]);
                                        try {
                                        ...
                                        var i = parseInt(r, 10);
                                        return bt(!isNaN(i)), new Ut(i, n.size(), "final" === o)
                                    }, o);
                                return i.headers = {
                                    "X-Goog-Upload-Command": "query"
                                }, i.errorHandler = yt(e), i
                            }(t.authWrapper_, t.location_, e, t.blob_),
                            o = t.authWrapper_.makeRequest(n, r);
                        t.request_ = o, o.getPromise().then(function (e) {
                    ...
                    var t = this,
                        ...
                        r = new Ut(this.transferred_, this.blob_.size()),
                        n = this.uploadUrl_;
                    this.resolveToken_(function (o) {
                        var i;
                        try {
                            i = Nt(t.location_, t.authWrapper_, n, t.blob_, e, t.mappings_, r, t.makeProgressCallback_())
                        } catch (e) {
                            return t.error_ = e, void t.transition_(O.ERROR)
                        }
                        var a = t.authWrapper_.makeRequest(i, o);
                        t.request_ = a, a.getPromise().then(function (e) {
                            t.increaseMultiplier_(), t.request_ = null, t.updateProgress_(e.current), e.finalized ? (t.metadata_ = e.metadata, t.transition_(O.SUCCESS)) : t.completeTransitions_()
                        }, t.errorHandler_)
                    })
                    ...
                    var t = this;
                    this.resolveToken_(function (e) {
                        var r = Et(t.authWrapper_, t.location_, t.mappings_),
                            n = t.authWrapper_.makeRequest(r, e);
                        t.request_ = n, n.getPromise().then(function (e) {
                            t.request_ = null, t.metadata_ = e, t.transition_(O.SUCCESS)
                    ...
                    this.resolveToken_(function (e) {
                        var r = function (t, e, r, n, o) {
                                ...
                                var p = {
                                    ...
                                    v = new mt(f, "POST", gt(t, r), _);
                                return v.urlParams = p, v.headers = a, v.body = h.uploadData(), v.errorHandler = yt(e), v
                            }(t.authWrapper_, t.location_, t.mappings_, t.blob_, t.metadata_),
                            n = t.authWrapper_.makeRequest(r, e);
                        t.request_ = n, n.getPromise().then(function (e) {
                            t.request_ = null, t.metadata_ = e, t.updateProgress_(t.blob_.size()), t.transition_(O.SUCCESS)
                        }, t.errorHandler_)
                    })
                    ...
                    get: function () {
                        var t = S(this.state_);
                        return new Ct(this.transferred_, this.blob_.size(), t, this.metadata_, this, this.ref_)
                    },
                    enumerable: !0,
                    configurable: !0
                }), t.prototype.on = function (t, e, r, n) {
                    void 0 === e && (e = void 0), void 0 === r && (r = void 0), void 0 === n && (n = void 0);
                    var o = "Expected a function or an Object with one of `next`, `error`, `complete` properties.",
                        i = ft(!0).validator,
                        a = pt(null, !0).validator;
                    ...
                    function s(t) {
                        ...
                        try {
                            if (a(t), !(M(t.next) || M(t.error) || M(t.complete))) throw "";
                            return
                        } catch (t) {
                            throw o
                        }
                    ...
                    st("on", [ct(function (e) {
                        if (t !== N.STATE_CHANGED) throw "Expected one of the event types: [" + N.STATE_CHANGED + "]."
                    }), pt(s, !0), ft(!0), ft(!0)], arguments);
                    var u = this;

                    function c(t) {
                        return function (e, r, o) {
                            null !== t && st("on", t, arguments);
                            var i = new Ot(e, r, n);
                            return u.addObserver_(i),
                                function () {
                                    u.removeObserver_(i)
                                }
                        }
                    ...
                    var e, r, n;
                    e = this.observers_, r = t, -1 !== (n = e.indexOf(r)) && e.splice(n, 1)
                }, t.prototype.notifyObservers_ = function () {
                    var t, e = this;
                    this.finishPromise_(), (t = this.observers_, Array.prototype.slice.call(t)).forEach(function (t) {
                        e.notifyObserver_(t)
                    })
                    ...
                    if (null !== this.resolve_) {
                        ...
                        switch (S(this.state_)) {
                            case C.SUCCESS:
                                St(this.resolve_.bind(null, this.snapshot))();
                                break;
                            case C.CANCELED:
                            case C.ERROR:
                                St(this.reject_.bind(null, this.error_))();
                                break;
                            default:
                                t = !1
                        }
                    ...
                    switch (S(this.state_)) {
                        case C.RUNNING:
                        case C.PAUSED:
                            null !== t.next && St(t.next.bind(t, this.snapshot))();
                            break;
                        case C.SUCCESS:
                            null !== t.complete && St(t.complete.bind(t))();
                            break;
                        case C.CANCELED:
                        case C.ERROR:
                            null !== t.error && St(t.error.bind(t, this.error_))();
                            break;
                        default:
                            null !== t.error && St(t.error.bind(t, this.error_))()
                    }
            ...
            It = function () {
                function t(t, e) {
                    this.authWrapper = t, this.location = e instanceof V ? e : V.makeFromUrl(e)
                }
                return t.prototype.toString = function () {
                    return st("toString", [], arguments), "gs://" + this.location.bucket + "/" + this.location.path
                }, t.prototype.newRef = function (e, r) {
                    return new t(e, r)
                }, t.prototype.mappings = function () {
                    return et()
                }, t.prototype.child = function (t) {
                    st("child", [ct()], arguments);
                    var e = function (t, e) {
                    ...
                    return void 0 === e && (e = null), st("put", [new ut(function (t) {
                        if (!(t instanceof Uint8Array || t instanceof ArrayBuffer || F() && t instanceof Blob)) throw "Expected Blob or File."
                    }), lt(!0)], arguments), this.throwIfRoot_("put"), new kt(this, this.authWrapper, this.location, this.mappings(), new _t(t), e)
                }, t.prototype.putString = function (t, e, r) {
                    void 0 === e && (e = g.RAW), st("putString", [ct(), ct(y, !0), lt(!0)], arguments), this.throwIfRoot_("putString");
                    var n = E(e, t),
                        o = P(r);
                    return !D(o.contentType) && D(n.contentType) && (o.contentType = n.contentType), new kt(this, this.authWrapper, this.location, this.mappings(), new _t(n.data, !0), o)
                }, t.prototype.delete = function () {
                    st("delete", [], arguments), this.throwIfRoot_("delete");
                    var t = this;
                    return this.authWrapper.getAuthToken().then(function (e) {
                        var r = function (t, e) {
                            var r = Z(e.fullServerUrl()),
                                n = t.maxOperationRetryTime(),
                                o = new mt(r, "DELETE", function (t, e) {}, n);
                            return o.successCodes = [200, 204], o.errorHandler = Rt(e), o
                        }(t.authWrapper, t.location);
                        return t.authWrapper.makeRequest(r, e).getPromise()
                    })
                }, t.prototype.getMetadata = function () {
                    st("getMetadata", [], arguments), this.throwIfRoot_("getMetadata");
                    var t = this;
                    return this.authWrapper.getAuthToken().then(function (e) {
                        var r = Et(t.authWrapper, t.location, t.mappings());
                        return t.authWrapper.makeRequest(r, e).getPromise()
                    })
                }, t.prototype.updateMetadata = function (t) {
                    st("updateMetadata", [lt()], arguments), this.throwIfRoot_("updateMetadata");
                    var e = this;
                    return this.authWrapper.getAuthToken().then(function (r) {
                        var n = function (t, e, r, n) {
                            var o = Z(e.fullServerUrl()),
                                ...
                                s = new mt(o, "PATCH", gt(t, n), a);
                            return s.headers = {
                                "Content-Type": "application/json; charset=utf-8"
                            }, s.body = i, s.errorHandler = Rt(e), s
                        }(e.authWrapper, e.location, t, e.mappings());
                        return e.authWrapper.makeRequest(n, r).getPromise()
                    })
                }, t.prototype.getDownloadURL = function () {
                    st("getDownloadURL", [], arguments), this.throwIfRoot_("getDownloadURL");
                    var t = this;
                    return this.authWrapper.getAuthToken().then(function (e) {
                        var r = wt(t.authWrapper, t.location, t.mappings());
                        return t.authWrapper.makeRequest(r, e).getPromise().then(function (t) {
                            if (null === t) throw new c(l.NO_DOWNLOAD_URL, "The given file does not have any download URLs.");
                            return t
                        })
                    })
                }, t.prototype.throwIfRoot_ = function (t) {
                    if ("" === this.location.path) throw function (t) {
                        return new c(l.INVALID_ROOT_OPERATION, "The operation '" + t + "' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")
                    }(t)
                }, t
            }(),
            Pt = function () {
            ...
            Lt = function () {
                function t(e, r, n, o, i) {
                    ...
                    this.storageRefMaker_ = r, this.requestMaker_ = n, this.pool_ = i, this.service_ = o, this.maxOperationRetryTime_ = a, this.maxUploadRetryTime_ = s, this.requestMap_ = new xt
                }
                return t.extractBucket_ = function (t) {
                    var e = t.storageBucket || null;
                    return null == e ? null : V.makeFromBucketSpec(e).bucket
                }, t.prototype.getAuthToken = function () {
                    return null !== this.app_ && D(this.app_.INTERNAL) && D(this.app_.INTERNAL.getToken) ? this.app_.INTERNAL.getToken().then(function (t) {
                    ...
                    if (this.deleted_) return new Pt(v());
                ...
                return t.prototype.start_ = function () {
                    ...
                    function e(e, r) {
                        var n, o = t.resolve_,
                            i = t.reject_,
                            a = r.xhr;
                        if (r.wasSuccessCode) try {
                            var s = t.callback_(a, a.getResponseText());
                            M(s) ? o(s) : o()
                        } catch (t) {
                            i(t)
                        } else null !== a ? ((n = p()).setServerResponseProp(a.getResponseText()), t.errorCallback_ ? i(t.errorCallback_(a, n)) : i(n)) : r.canceled ? i(n = t.appDelete_ ? v() : f()) : i(n = new c(l.RETRY_LIMIT_EXCEEDED, "Max retry time for operation exceeded, please try again."))
                    }
                    this.canceled_ ? e(0, new Mt(!1, null, !0)) : this.backoffId_ = function (t, e, r) {
                        var n = 1,
                            o = null,
                            i = !1,
                            a = 0;
                        ...
                        function h(t) {
                            ...
                            u || (t ? c.apply(null, arguments) : s() || i ? c.apply(null, arguments) : (n < 64 && (n *= 2), 1 === a ? (a = 2, e = 0) : e = 1e3 * (n + Math.random()), l(e)))
                        }
                        var p = !1;

                        function f(t) {
                            p || (p = !0, u || (null !== o ? (t || (a = 2), clearTimeout(o), l(0)) : t || (a = 1)))
                        }
                        return l(0), setTimeout(function () {
                            i = !0, f(!0)
                        }, r), f
                    }(function (e, r) {
                        if (r) e(!1, new Mt(!1, null, !0));
                        else {
                            var n = t.pool_.createXhrIo();
                            t.pendingXhr_ = n, null !== t.progressCallback_ && n.addUploadProgressListener(o), n.send(t.url_, t.method_, t.body_, t.headers_).then(function (r) {
                                null !== t.progressCallback_ && r.removeUploadProgressListener(o), t.pendingXhr_ = null;
                                var n = (r = r).getErrorCode() === A.NO_ERROR,
                                    i = r.getStatus();
                                if (n && !t.isRetryStatusCode_(i)) {
                                    var a = vt(t.successCodes_, i);
                                    e(!0, new Mt(a, r))
                                } else {
                    ...
                    var e = t >= 500 && t < 600,
                        r = vt([408, 429], t),
                        n = vt(this.additionalRetryCodes_, t);
                    return e || r || n
                }, t
            }(),
            Mt = function () {
        ...
        function Wt(t, r, n) {
            ...
            return function (t, e) {
                ...
                }(a), new Dt(i, t.method, a, t.body, t.successCodes, t.additionalRetryCodes, t.handler, t.errorHandler, t.timeout, t.progressCallback, n)
        }
        var Bt = function () {
                function t(t, e, r) {
                    if (this.bucket_ = null, this.authWrapper_ = new Lt(t, function (t, e) {
                            return new It(t, e)
                        }, Wt, this, e), this.app_ = t, null != r) this.bucket_ = V.makeFromBucketSpec(r);
                    else {
                        var n = this.authWrapper_.bucket();
                        null != n && (this.bucket_ = new V(n, ""))
                    }
                    this.internals_ = new Gt(this)
                }
                return t.prototype.ref = function (t) {
                    if (st("ref", [ct(function (t) {
                    ...
                    var e = new It(this.authWrapper_, this.bucket_);
                    return null != t ? e.child(t) : e
                }, t.prototype.refFromURL = function (t) {
                    return st("refFromURL", [ct(function (t) {
                    ...
                    }, !1)], arguments), new It(this.authWrapper_, t)
                    ...
                    st("setMaxUploadRetryTime", [ht()], arguments), this.authWrapper_.setMaxUploadRetryTime(t)
                    ...
                    st("setMaxOperationRetryTime", [ht()], arguments), this.authWrapper_.setMaxOperationRetryTime(t)
            ...
            Gt = function () {
                ...
                return t.prototype.delete = function () {
                    return this.service_.authWrapper_.deleteApp(), L(void 0)
                }, t
            }(),
            jt = "storage";

        function qt(t, e, r) {
            return new Bt(t, new z, r)
        }
        Ft = {
            TaskState: C,
            TaskEvent: N,
            ...
            Storage: Bt,
            Reference: It
        }, e.INTERNAL.registerService(jt, qt, Ft, void 0, !0)
    } catch (t) {
        throw console.error(t), new Error("Cannot instantiate firebase-storage - be sure to load firebase-app.js first.")
    }
    var Ft
