...
var files = ['/', 'css/app.css', 'index.html', 'js/core.js', 'js/config.js', 'js/init.js', 'js/checkin.js', 'external/js/intl-utils.js', 'external/js/intlTelInput.min.js', 'external/js/moment.min.js', 'external/img/flags.png', 'external/img/flags@2x.png', 'external/css/intlTelInput.css'];
var staticCacheName = 'pages-cache-v33';
